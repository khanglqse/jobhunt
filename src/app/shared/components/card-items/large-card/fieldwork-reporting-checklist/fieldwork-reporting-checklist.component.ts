...
@Component({
  selector: 'iap-fieldwork-reporting-checklist',
  templateUrl: './fieldwork-reporting-checklist.component.html',
  styleUrls: ['./fieldwork-reporting-checklist.component.scss']
})
export class FieldworkReportingChecklistComponent implements OnInit {
  color = '#58478D';
